...
> & {
  ...
  medium?: StorefrontTypes.Maybe<
    Pick<StorefrontTypes.Metafield, 'value' | 'type'>
  >
  dimensions?: StorefrontTypes.Maybe<
    Pick<StorefrontTypes.Metafield, 'value' | 'type'>
  >
}
...
export type HomeArtworkProductFragment = Pick<
  StorefrontTypes.Product,
  'id' | 'title' | 'handle'
> & {
  images: {
  ...
  dimensionsImperial?: StorefrontTypes.Maybe<
    Pick<StorefrontTypes.Metafield, 'value' | 'type'>
  >
  dimensionsMetric?: StorefrontTypes.Maybe<
    Pick<StorefrontTypes.Metafield, 'value' | 'type'>
  >
  medium?: StorefrontTypes.Maybe<
    Pick<StorefrontTypes.Metafield, 'value' | 'type'>
...
export type HighlightedArtworksQueryVariables = StorefrontTypes.Exact<{
  ...
  productsFirst?: StorefrontTypes.InputMaybe<
    StorefrontTypes.Scalars['Int']['input']
  >
  imagesFirst?: StorefrontTypes.InputMaybe<
    StorefrontTypes.Scalars['Int']['input']
  >
}>

export type HighlightedArtworksQuery = {
  collectionByHandle?: StorefrontTypes.Maybe<{
    products: {
      edges: Array<{
        node: Pick<StorefrontTypes.Product, 'id' | 'title' | 'handle'> & {
          images: {
            edges: Array<{
              node: Pick<
                StorefrontTypes.Image,
...
export type PageQuery = {
  page?: StorefrontTypes.Maybe<
    ...
    > & {
      seo?: StorefrontTypes.Maybe<
        Pick<StorefrontTypes.Seo, 'title' | 'description'>
      >
    }
  >
}

export type ShopPoliciesQueryVariables = StorefrontTypes.Exact<{
  [key: string]: never
}>

export type ShopPoliciesQuery = {
  shop: {
    privacyPolicy?: StorefrontTypes.Maybe<
      Pick<StorefrontTypes.ShopPolicy, 'handle' | 'title' | 'body'>
    >
    refundPolicy?: StorefrontTypes.Maybe<
      Pick<StorefrontTypes.ShopPolicy, 'handle' | 'title' | 'body'>
    >
    termsOfService?: StorefrontTypes.Maybe<
      Pick<StorefrontTypes.ShopPolicy, 'handle' | 'title' | 'body'>
    >
    shippingPolicy?: StorefrontTypes.Maybe<
      Pick<StorefrontTypes.ShopPolicy, 'handle' | 'title' | 'body'>
    >
  }
}
...
interface GeneratedQueryTypes {
  ...
  '\n  \n  fragment HomeArtworkProduct on Product {\n    id\n    title\n    handle\n    images(first: $imagesFirst) {\n      edges {\n        node {\n          id\n          url\n          altText\n          width\n          height\n        }\n      }\n    }\n    dimensionsImperial: metafield(namespace: "custom", key: "dimensions_us") {\n      value\n      type\n    }\n    dimensionsMetric: metafield(namespace: "custom", key: "dimensions_global") {\n      value\n      type\n    }\n    medium: metafield(namespace: "custom", key: "medium") {\n      value\n      type\n    }\n  }\n\n  query HighlightedArtworks(\n    $collectionHandle: String!\n    $productsFirst: Int = 4\n    $imagesFirst: Int = 1\n  ) {\n    collectionByHandle(handle: $collectionHandle) {\n      products(\n        first: $productsFirst\n        sortKey: COLLECTION_DEFAULT\n        filters: [{ available: true }]\n      ) {\n        edges {\n          node {\n            ...HomeArtworkProduct\n          }\n        }\n      }\n    }\n  }\n': {
    return: HighlightedArtworksQuery
    variables: HighlightedArtworksQueryVariables
  }
  '\n  \n  fragment HomeArtworkProduct on Product {\n    id\n    title\n    handle\n    images(first: $imagesFirst) {\n      edges {\n        node {\n          id\n          url\n          altText\n          width\n          height\n        }\n      }\n    }\n    dimensionsImperial: metafield(namespace: "custom", key: "dimensions_us") {\n      value\n      type\n    }\n    dimensionsMetric: metafield(namespace: "custom", key: "dimensions_global") {\n      value\n      type\n    }\n    medium: metafield(namespace: "custom", key: "medium") {\n      value\n      type\n    }\n  }\n\n  query RecentArtworks($productsFirst: Int = 4, $imagesFirst: Int = 1) {\n    products(\n      first: $productsFirst\n      sortKey: CREATED_AT\n      reverse: true\n      query: "available_for_sale:true"\n    ) {\n      edges {\n        node {\n          ...HomeArtworkProduct\n        }\n      }\n    }\n  }\n': {
    return: RecentArtworksQuery
